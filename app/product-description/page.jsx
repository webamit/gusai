...
export default function Home() {
  ...
  const [keyBenefitsFeatures, setKeyBenefitsFeatures] = useState('');
  // Response message
  ...
  const handleTranslate = async () => {
    ...
    if (!keyBenefitsFeatures) {
      alert('Please enter the key benefits / features.');
      return;
    }
  ...
  const handleKeyBenefitsFeatures = (Event) => {
      ...
      >
        ...
        >
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            What your product description will be about?
          </Text>
          <FormLabel
            display="flex"
            ms="10px"
        ...
        <Card maxW="100%" h="100%">
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            Enjoy your new product description!
          </Text>
