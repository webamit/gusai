...
export default function Home() {
  ...
  const handleTranslate = async () => {
    ...
    if (!audience) {
      alert('Please choose the audience.');
      return;
    }
    ...
    // -------------- Fetch --------------
    const response = await fetch('/api/linkedinMessageAPI', {
      method: 'POST',
      headers: {
      ...
      >
        ...
        >
          ...
          <Text fontSize={'16px'} color="gray.500" fontWeight="500" mb="30px">
            What your LinkedIn Message will be about?
          </Text>
          <FormLabel
            display="flex"
            ms="10px"
          ...
          <Input
            ...
            id="audience"
            fontWeight="500"
            placeholder="Type here the audience..."
            _placeholder={placeholderColor}
            _focus={{ borderColor: 'none' }}
            mb="28px"
